...
export const createForm = (elements) => {
  const form = new FormData();
  for (let item of Object.keys(elements)) form.append(item, elements[item]);
  return form;
};
...
export const getRandomChar = (length, options = rand_options) => {
